...
def predict_status(ctry, itmtp, aplcn, wth, prdrf, qtlg, cstlg, tknslg, slgplg, itmdt, itmmn, itmyr, deldtdy, deldtmn, deldtyr):
    ...
    with open(r"C:\Users\HP\classification_model.pkl", "rb") as f:
...
def predict_selling_price(ctry, sts, itmtp, aplcn, wth, prdrf, qtlg, cstlg, tknslg, itmdt, itmmn, itmyr, deldtdy, deldtmn, deldtyr):
    ...
    with open(r"C:\Users\HP\regression_model.pkl", "rb") as f:
    ...
    # Format the selling price to two decimal places
    formatted_price = "{:.2f}".format(ac_y_pred)
...
with st.sidebar:
    option = option_menu('Copper Modelling', options=["PREDICT SELLING PRICE", "PREDICT STATUS"])
